...
class Customer
{
    ...
    protected function getCustomerInfo_ByCusIdFromCustomer($customerId)
    {
    ...
    ///////////////////////////// Public Access ///////////////////////
    public function giveCustomerInfo_ByCusIdFromCustomer($customerId)
    {
        $result = $this->getCustomerInfo_ByCusIdFromCustomer($customerId);
        return $result;
    }
