...
<div class="container-fluid contact">
    ...
    <div class=" row p-5">
        <!-- login -->
        <div class="col-sm-5 text-muted p-5 mt-5 ml-4 mx-5 contactBg">

            <p class="font-weight-lighter text-uppercase contactEmail" style="font-family: montserrat,serif; font-size: xx-large"><i class="fas fa-key" style="transform: scaleX(-1);"></i> LOGIN</p>

            <form id="newCustomer" enctype="multipart/form-data" method="POST" action="../controller/login_controller.php?type=login">
                <label class="control-label text-light">Username <span class="text-danger"> *</span></label>
                <input type="email" class="form-control" name="email" id="email" placeholder="Email" value="<?php echo $email; ?>" required>
                <br>
                <label class="control-label text-light">Password <span class="text-danger"> *</span></label>
                ...
                <button class="btn button text-dark text-uppercase mt-3 navmenu">Login</button>&nbsp; | &nbsp;
        ...
        <!-- register -->
        <div class="col-sm-5 text-muted p-5 mt-5 mx-5 contactBg">
            <p class="font-weight-lighter text-uppercase contactEmail" style=" font-family: montserrat,serif; font-size: xx-large"><i class="fas fa-clipboard-user"></i> REGISTER</p>
            ...
            <form enctype="multipart/form-data" method="POST" action="../controller/login_controller.php?type=sendOTP">
                ...
                <br>
                <p class="text-light">A Temporary password will be sent to your email address.</p>
                <p class="text-justify text-light">Your personal data will be used to support your experience throughout this website, to manage access to your account, and for other purposes described in our privacy policy.</p>
                <button type="submit" class="btn button text-dark  text-uppercase navmenu" id="registerBtn">REGISTER</button>
            </form>
...
<script>
    document.title = "NALAKA STORES | Login";
</script>
