...
<div class="container-fluid contact">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-12 text-center p-5" style="background-image:url('../image/background/black.png');">
            <p class="text-uppercase p-2 mt-5 text-white font-weight-lighter" style=" font-family: montserrat,serif; font-size: 40px;">My Profile Dashboard</p>
        ...
        <div class="col-sm-12 d-flex flex-column flex-sm-row justify-content-sm-around align-items-center ">
            ...
            <div>
                <a href="editCustomer.php" class="button btn border-0 text-dark text-uppercase navmenu">
                    <i class="fas fa-user-edit"></i>
                    Edit Info
                </a>
                <a href="changePassword.php" class="btn button btn-warning text-dark text-uppercase navmenu">
            ...
            <div class="card mb-5">
                <div class="card-body mb-5">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a id="OrderHistoryNav" class="nav-link text-uppercase active text-dar" data-toggle="tab" href="#OrderHistory">Order History</a>
                        </li>
                        <li class="nav-item">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if ($row["order_status"] == 1 && $getFeedback->num_rows < 1) { ?>
...
<div class="modal fade" id="moreDetailsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle1" aria-hidden="true" style="overflow-x: scroll; max-width:100vw;">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #FFC0CB">
                <h5 class="modal-title text-dark text-uppercase" id="exampleModalLongTitle1"><i class="fas fa-shipping-fast"></i> &nbsp; View Ordered Details</h5>
...
<script>
    document.title = "NALAKA STORES | Profile";
</script>
