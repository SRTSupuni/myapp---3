            ...
            <div class="row">
                ...
                <div class="col-md-12 text-danger p-5">
                    ...
                    <form class="pb-5" id="forgetPassword" enctype="multipart/form-data" method="POST" action="../controller/login_controller.php?type=sendResetLink">
                        ...
                        <button type="submit" class="btn button text-white text-uppercase navmenu" id="changePW">Reset password</button>
                    </form>
                </div>
                <!--  reset password end -->
            </div>
...
<!-- content end -->
<script>
    document.title = "NALAKA STORES | Forgot Password";
</script>
