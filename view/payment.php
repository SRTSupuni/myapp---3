            ...
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3 scard">
                ...
                <form id="paymentForm" enctype="multipart/form-data" method="POST" action="../controller/order_controller.php?type=addOrder">
                    ...
                    <ul id="progressbar" class="p-0">
                        <li class="active text-uppercase" id="shiping"><strong>Your Details</strong></li>
                    ...
                    <fieldset class="mt-3">
                        ...
                        <input type="button" id="shippingDetails" name="next" class="next action-button btn button text-dark text-uppercase btn-block navmenu" value="Next" />
                    </fieldset>
                    <!-- ////////////////////////// 1st Fieldset End ////////////////////////////////// -->
                    ...
                    <fieldset class="mt-3">
                        ...
                        <input type="submit" id="pay" class="action-button btn button text-dark text-uppercase btn-block navmenu" value="Pay" />
...
<script>
    document.title = "NALAKA STORES | Payment";
</script>
