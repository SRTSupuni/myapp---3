        ...
        if ($invId) {
            ...
            if ($result) {
                ...
                $body = '<div style="padding: 20px;">
                    <h1 style="background-color: #FFC0CB; color: black; text-align:center; padding: 10px;">Thank You For Your Order</h1>
                    <h2>Hi..' . $fname . ' ' . $lname . ' </h2>
                    <h3>Just to let you know — we have received your order ' . $newInvoiceNum . ', and it is now being processed :</h3>
                    <p>Invoice Number :[' . $newInvoiceNum . '] Date : [' . $today . ']</p>

                    <table style="border:solid thin; width:100%; border-collapse:collapse;">
                        <thead>
                            <tr>
                                <th style="border: solid thin; padding:10px">Product</th>
                                <th style="border: solid thin; padding:10px">Price</th>
                                <th style="border: solid thin; padding:10px">Quantity</th>
                                <th style="border: solid thin; padding:10px">Subtotal</th>
                            </tr>
                        </thead>
                        <tbody>';
                ...
                foreach ($_SESSION["cart"] as $key => $value) {
                    ...
                    $_SESSION["productId"] = $_POST;

                    $body .= '<tr>
                    <td style="border:solid thin; padding:10px">'
                ...
                $body .= '<tr>
                <td colspan="3" style="border:solid thin; text-align:right; padding:10px">
                Net Total 
                </td>
                <td style="border:solid thin; padding:10px">'
                    . $total .
                ...
                header("Location: ../view/download.php?response=$response&res_status=$status");
            } else {
